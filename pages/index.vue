<template>
  <!-- header -->
  <!-- <button
    class="fixed left-10 bottom-10 h-20 w-20 rounded-full justify-center drop-shadow-lg z-20 hover:opacity-60"
    style="
      height: ;
    ...
    "
  ></button> -->
  <div class="flex justify-around z-10 mt-5">
    <div class="flex lg:gap-16 gap-6 z-10 text-primary">
      <button>Home</button>
      <button>About</button>
      <button>Contact</button>
    </div>
    <div class="z-10">
      <boton class="z-10 lg:py-1 py-0 px-5 lg:px-10" texto="Buy Now"></boton>
    </div>
  </div>
  <main class="max-w-5xl mx-auto">
    <!-- Intro -->
    <div
      class="flex items-center justify-start mt-64 lg:mt-0 lg:ml-40 h-[31rem] lg:h-[900px]"
    >
      <div class="z-10 max-w-lg">
        <h2
          class="text-secondary text-4xl lg:text-5xl mb-7 lg:mb-3 text-center lg:text-start"
        >
          Introduce Your Product Quickly & Effectively
        </h2>
        <p
          class="text-primary text-lg text-center lg:text-start max-w-md lg:pt-5 mb-10 lg:mb-0 lg:pb-16"
        >
        ...
        <div class="flex lg:gap-7 justify-around px-3 lg:px-0 lg:justify-start">
          <Boton texto="Purchas UI Kit"></Boton>
          <boton texto="Learn More" transparente="si"></boton>
        </div>
      </div>
    ...
    <ContadorComp></ContadorComp>
    <!-- Intro Cero -->
    <div
      class="flex justify-around items-center flex-col-reverse lg:flex-row px-3 lg:px-0"
      style="max-height: 742px"
    >
      <div>
        <div class="mb-20">
          <h2 class="text-secondary text-4xl lg:mt-0 mt-3 mb-3">
            Light, Fast & Powerfull
          </h2>
          <p class="text-primary lg:text-start text-center max-w-md mt-7">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
        ...
        <div class="flex flex-row gap-7">
          <div class="lg:w-64">
            ...
            <h3 class="font-medium mt-3 mb-1">Title goes here</h3>
            <p class="text-xs" style="color: #5d6970">
              Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
    ...
    <Intro
      ...
      imagen="images/intro3.png"
      texto="Purchase Now"
    ></Intro>
  </main>
  <!-- A Price To Suit -->
  <div
    class="relative flex justify-center py-48 z-10"
    style="background-image: url('images/footfondo.png')"
    data-aos="fade-up"
    data-aos-duration="2000"
  >
    <div class="max-w-xl text-center">
      <div class="pb-9">
        <h1 class="text-secondary text-4xl pb-4">A Price To Suit Everyone</h1>
      ...
      <div class="pb-14">
        <h1
          class="text-secondary text-5xl font-medium p-1"
          style="color: #222f65"
        >
          $40
        </h1>
      ...
      <div>
        <p class="text-sm p-2" style="color: #5d6970">
          See, One price. Simple.
        </p>
        <boton texto="Purchase Now"></boton>
      </div>
    </div>
  </div>
  <!-- footer -->
  <footer style="height: 216px" class="bg-footer pt-16 flex flex-col">
    <div class="flex justify-around">
      <div style="color: #939ea4" class="text-sm">©2023 Yourcompany</div>
      <br />
      <boton texto="Purchase Now"></boton>
    </div>
    <!-- <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <rect width="1110"  height="1" fill="#CDD1D4" />
    </svg> -->
    <hr class="my-8" />
    <div class="flex justify-around">
      <div class="flex gap-2">
        <button class="text-textfooter">Home</button>
        <button class="text-textfooter">About</button>
        <button class="text-textfooter">Contact</button>
      </div>
      <br />
      <div class="flex gap-2">
        <svg
